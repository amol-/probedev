...
- Challenge: Review of README intent, executable code, and evolutions to find drift, missing flows, stale work, or ordering problems.
- Developer: Human using the probe toolkit to guide software work.
- Evolution: Ordered code-local planned change anchored by `TODO(PROBE-...)` syntax.
