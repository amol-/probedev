...
- Evolution: Ordered code-local planned change anchored by `TODO(EVO-...)` syntax.
- Evolutions.txt: Special file that can contain evolution markers, used as the target when adding an evolution to a directory.
